...
public class ModelAngelEd <T extends LivingEntity> extends BipedModel<T>{
	...
	public ModelAngelEd() {
		...
		teeth_1.addCuboid(-1.0F, 0.0F, -0.03F, 1, 1, 1, 0.0F);
		...
		teeth_3.addCuboid(-1.0F, 0.0F, -0.03F, 1, 1, 1, 0.0F);
		...
		right_arm.addCuboid(-2.0F, -2.0F, -2.0F, 3, 6, 4, 0.0F);
		...
		teeth_5.addCuboid(-1.0F, 0.0F, -0.03F, 1, 1, 1, 0.0F);
		...
		cloth_2.addCuboid(-3.0F, -1.0F, -2.5F, 6, 1, 3, 0.0F);
		left_wing_1 = new ModelRenderer(this, 24, 0);
		left_wing_1.setRotationPoint(2.4F, 2.0F, 1.5F);
		left_wing_1.addCuboid(-1.0F, 0.0F, -1.0F, 2, 4, 2, 0.0F);
		...
		head_2.addCuboid(-4.0F, -8.0F, -4.0F, 8, 8, 8, 0.5F);
		right_wing_2 = new ModelRenderer(this, 46, 27);
		right_wing_2.setRotationPoint(0.0F, 4.0F, -1.0F);
		right_wing_2.addCuboid(-1.0F, 0.0F, 0.0F, 2, 7, 2, 0.0F);
		...
		right_wing_4.addCuboid(-1.0F, 0.0F, -2.0F, 2, 5, 2, 0.0F);
		...
		body_2.addCuboid(-4.0F, 0.0F, -2.0F, 8, 23, 4, 0.25F);
		right_wing_1 = new ModelRenderer(this, 0, 0);
		right_wing_1.setRotationPoint(-2.4F, 2.0F, 1.5F);
		right_wing_1.addCuboid(-1.0F, 0.0F, -1.0F, 2, 4, 2, 0.0F);
		...
		teeth.addCuboid(-1.0F, 0.0F, -0.03F, 1, 1, 1, 0.0F);
		...
		left_wing_0.addCuboid(-1.0F, 0.0F, -13.0F, 1, 11, 18, 0.0F);
		...
		left_wing_3.addCuboid(-1.0F, 0.0F, -2.0F, 2, 5, 2, 0.0F);
		...
		right_arm_1.addCuboid(-2.0F, 0.0F, -4.0F, 3, 6, 4, 0.0F);
	...
	private void angelAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netheadYaw, float headPitch, float scaleFactor, Entity entity) {
        ...
        if (entity instanceof WeepingAngelEntity) {
			...
			if (pose != null) {
				angry_mouth.showModel = pose.angryFace();
				pose.setArmAngles(left_arm, right_arm, left_arm_1, right_arm_1);
				pose.setWingAngles(left_wing_0, right_wing_0);
				pose.setHeadAngles(head);
