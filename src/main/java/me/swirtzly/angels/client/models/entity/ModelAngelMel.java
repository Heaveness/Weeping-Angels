...
public class ModelAngelMel<T extends LivingEntity> extends EntityModel<WeepingAngelEntity> {
	...
	public ModelAngelMel() {
		...
		Eye1.addCuboid(-1.5F, -4.25F, -3.1F, 1, 1, 1);
		...
		Eye2.addCuboid(0.5F, -4.25F, -3.1F, 1, 1, 1);
		...
		EyeBacking.addCuboid(-2F, -4.5F, -2.9F, 4, 2, 1);
		...
		EyeMiddle.addCuboid(-0.5F, -4.5F, -3F, 1, 2, 1);
		...
		Hair8.addCuboid(-2F, -2F, 1.75F, 4, 1, 1);
		...
		EarLeft.addCuboid(0F, -4F, 0F, 1, 2, 2);
		...
		EarRight.addCuboid(-1F, -4F, 0F, 1, 2, 2);
		...
		MouthAngle1.addCuboid(-1F, 0F, -1F, 1, 1, 1);
		...
		MouthAngle2.addCuboid(0F, 0F, -1F, 1, 1, 1);
		...
		Chin.addCuboid(-1.5F, -1F, -3F, 3, 1, 1);
		...
		Noselower.addCuboid(-2F, -3F, -3F, 4, 1, 1);
		...
		MouthInner.addCuboid(-1.75F, -2F, -2.7F, 3, 1, 1);
		...
		MouthUpper.addCuboid(-1.5F, -2.5F, -3F, 3, 1, 1);
		...
		EyeAngle1.addCuboid(0F, -1F, 0F, 2, 1, 1);
		...
		EyeAngle2.addCuboid(-2F, -1F, 0F, 2, 1, 1);
		...
		MouthUpper2.addCuboid(1F, -2F, -3F, 1, 2, 1);
		...
		Forehead2.addCuboid(-2F, -5.5F, -3F, 4, 1, 1);
		...
		Forehead5.addCuboid(-2.5F, -7.5F, -2F, 5, 1, 4);
		...
		MouthUpper3.addCuboid(-2F, -2F, -3F, 1, 2, 1);
		...
		Tooth3.addCuboid(-1F, -1F, -0.8F, 1, 1, 1);
		...
		Tooth1.addCuboid(-1F, -1F, -0.8F, 1, 1, 1);
		...
		Tooth2.addCuboid(-1F, -1F, -0.8F, 1, 1, 1);
		...
		HeadBand2.addCuboid(-3F, -5F, -5F, 6, 1, 6);
		...
		HeadBand3.addCuboid(-3.5F, -5F, -4.5F, 7, 1, 5);
		...
		HeadCap2.addCuboid(-2F, -7.5F, -2.5F, 4, 1, 5);
		...
		Neck.addCuboid(-2F, -1F, -1.5F, 4, 1, 3);
		Neck.setRotationPoint(0F, 0F, 0F);
		Neck.setTextureSize(128, 128);
		Neck.mirror = true;
		setRotation(Neck, 0F, 0F, 0F);
		TorsoMain = new ModelRenderer(this, 39, 25);
		TorsoMain.addCuboid(-3.5F, 0F, -2F, 7, 10, 4);
		...
		Dress1.addCuboid(-3.5F, 0F, 0F, 7, 8, 1);
		...
		Dress2.addCuboid(-3.5F, 0F, -1F, 7, 8, 1);
		...
		Dress3.addCuboid(-3F, 0F, 0F, 6, 14, 1);
		...
		Dress4.addCuboid(-3F, 9F, 1.5F, 6, 5, 1);
		...
		Dress5.addCuboid(-3F, 10F, 4F, 6, 4, 1);
		...
		Dress6.addCuboid(-2F, 0F, -2.5F, 2, 14, 5);
		...
		Dress7.addCuboid(-3.5F, 9F, -2.5F, 2, 5, 5);
		...
		Dress8.addCuboid(-6F, 10F, -2.5F, 2, 4, 5);
		...
		Dress9.addCuboid(-3F, 0F, -1F, 6, 14, 1);
		...
		Dress10.addCuboid(-3F, 9F, -2.5F, 6, 5, 1);
		...
		Dress11.addCuboid(-3F, 10F, -5F, 6, 4, 1);
		...
		Dress12.addCuboid(0F, 0F, -2.5F, 2, 14, 5);
		...
		Dress13.addCuboid(1.5F, 9F, -2.5F, 2, 5, 5);
		...
		Dress14.addCuboid(4F, 10F, -2.5F, 2, 4, 5);
		...
		LeftWing1.addCuboid(6F, 0F, -1F, 1, 16, 1);
		...
		LeftWing2.addCuboid(5F, -1F, -1F, 1, 16, 1);
		...
		LeftWing3.addCuboid(4F, -2F, -1F, 1, 16, 1);
		...
		LeftWing4.addCuboid(3F, -2F, -1F, 1, 14, 1);
		...
		LeftWing5.addCuboid(2F, -1F, -1F, 1, 11, 1);
		...
		LeftWing6.addCuboid(0F, 1F, -1F, 2, 5, 1);
		...
		LeftWing7.addCuboid(0F, 1F, -3F, 1, 5, 3);
		...
		RightWing1.addCuboid(-7F, 0F, -1F, 1, 16, 1);
		...
		RightWing2.addCuboid(-6F, -1F, -1F, 1, 16, 1);
		...
		RightWing3.addCuboid(-5F, -2F, -1F, 1, 16, 1);
		...
		RightWing4.addCuboid(-4F, -2F, -1F, 1, 14, 1);
		...
		RightWing5.addCuboid(-3F, -1F, -1F, 1, 11, 1);
		...
		RightWing6.addCuboid(-2F, 1F, -1F, 2, 5, 1);
		...
		RightWing7.addCuboid(-1F, 1F, -3F, 1, 5, 3);
	...
	@Override
	public void setAngles(WeepingAngelEntity weepingAngelEntity, float v, float v1, float v2, float v3, float v4) {
	...
	public void render(MatrixStack matrixStack, IVertexBuilder iVertexBuilder, int i, int i1, float v, float v1, float v2, float v3) {
		Eye1.render(matrixStack, iVertexBuilder, i, i1);
		Eye2.render(matrixStack, iVertexBuilder, i, i1);
		EyeBacking.render(matrixStack, iVertexBuilder, i, i1);
		EyeMiddle.render(matrixStack, iVertexBuilder, i, i1);
		Hair1.render(matrixStack, iVertexBuilder, i, i1);
		Hair2.render(matrixStack, iVertexBuilder, i, i1);
		Hair3.render(matrixStack, iVertexBuilder, i, i1);
		Hair4.render(matrixStack, iVertexBuilder, i, i1);
		Hair5.render(matrixStack, iVertexBuilder, i, i1);
		Hair6.render(matrixStack, iVertexBuilder, i, i1);
		Hair7.render(matrixStack, iVertexBuilder, i, i1);
		Hair8.render(matrixStack, iVertexBuilder, i, i1);
		EarLeft.render(matrixStack, iVertexBuilder, i, i1);
		EarRight.render(matrixStack, iVertexBuilder, i, i1);
		Nose.render(matrixStack, iVertexBuilder, i, i1);
		HeadBack.render(matrixStack, iVertexBuilder, i, i1);
		MouthAngle1.render(matrixStack, iVertexBuilder, i, i1);
		MouthAngle2.render(matrixStack, iVertexBuilder, i, i1);
		Chin.render(matrixStack, iVertexBuilder, i, i1);
		Noselower.render(matrixStack, iVertexBuilder, i, i1);
		MouthInner.render(matrixStack, iVertexBuilder, i, i1);
		MouthUpper.render(matrixStack, iVertexBuilder, i, i1);
		EyeAngle1.render(matrixStack, iVertexBuilder, i, i1);
		EyeAngle2.render(matrixStack, iVertexBuilder, i, i1);
		MouthUpper2.render(matrixStack, iVertexBuilder, i, i1);
		Forehead2.render(matrixStack, iVertexBuilder, i, i1);
		Forehead5.render(matrixStack, iVertexBuilder, i, i1);
		MouthUpper3.render(matrixStack, iVertexBuilder, i, i1);
		Tooth3.render(matrixStack, iVertexBuilder, i, i1);
		Tooth1.render(matrixStack, iVertexBuilder, i, i1);
		Tooth2.render(matrixStack, iVertexBuilder, i, i1);
		HeadBand2.render(matrixStack, iVertexBuilder, i, i1);
		Head2.render(matrixStack, iVertexBuilder, i, i1);
		Headband1.render(matrixStack, iVertexBuilder, i, i1);
		HeadBand3.render(matrixStack, iVertexBuilder, i, i1);
		Head3.render(matrixStack, iVertexBuilder, i, i1);
		HeadCap1.render(matrixStack, iVertexBuilder, i, i1);
		HeadCap2.render(matrixStack, iVertexBuilder, i, i1);
		Neck.render(matrixStack, iVertexBuilder, i, i1);
		TorsoMain.render(matrixStack, iVertexBuilder, i, i1);
		Dress1.render(matrixStack, iVertexBuilder, i, i1);
		Dress2.render(matrixStack, iVertexBuilder, i, i1);
		Dress3.render(matrixStack, iVertexBuilder, i, i1);
		Dress4.render(matrixStack, iVertexBuilder, i, i1);
		Dress5.render(matrixStack, iVertexBuilder, i, i1);
		Dress6.render(matrixStack, iVertexBuilder, i, i1);
		Dress7.render(matrixStack, iVertexBuilder, i, i1);
		Dress8.render(matrixStack, iVertexBuilder, i, i1);
		Dress9.render(matrixStack, iVertexBuilder, i, i1);
		Dress10.render(matrixStack, iVertexBuilder, i, i1);
		Dress11.render(matrixStack, iVertexBuilder, i, i1);
		Dress12.render(matrixStack, iVertexBuilder, i, i1);
		Dress13.render(matrixStack, iVertexBuilder, i, i1);
		Dress14.render(matrixStack, iVertexBuilder, i, i1);
		LeftWing1.render(matrixStack, iVertexBuilder, i, i1);
		LeftWing2.render(matrixStack, iVertexBuilder, i, i1);
		LeftWing3.render(matrixStack, iVertexBuilder, i, i1);
		LeftWing4.render(matrixStack, iVertexBuilder, i, i1);
		LeftWing5.render(matrixStack, iVertexBuilder, i, i1);
		LeftWing6.render(matrixStack, iVertexBuilder, i, i1);
		LeftWing7.render(matrixStack, iVertexBuilder, i, i1);
		RightWing1.render(matrixStack, iVertexBuilder, i, i1);
		RightWing2.render(matrixStack, iVertexBuilder, i, i1);
		RightWing3.render(matrixStack, iVertexBuilder, i, i1);
		RightWing4.render(matrixStack, iVertexBuilder, i, i1);
		RightWing5.render(matrixStack, iVertexBuilder, i, i1);
		RightWing6.render(matrixStack, iVertexBuilder, i, i1);
		RightWing7.render(matrixStack, iVertexBuilder, i, i1);
