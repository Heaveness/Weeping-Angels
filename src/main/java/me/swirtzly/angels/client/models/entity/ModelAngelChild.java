...
public class ModelAngelChild<T extends LivingEntity> extends BipedModel<T> {
	...
	public ModelAngelChild() {
		...
		mouthtop.addCuboid(-3.5F, -2.6F, -0.01F, 7, 2, 1, 0.0F);
		left_arm = new ModelRenderer(this, 0, 48);
		left_arm.setRotationPoint(5.0F, 2.5F, -0.0F);
		left_arm.addCuboid(-1.0F, -2.0F, -2.0F, 3, 12, 4, 0.0F);
		...
		right_wing_3_1.addCuboid(-1.0F, 0.0F, -2.0F, 2, 5, 2, 0.0F);
		...
		right_wing_4_1.addCuboid(-1.0F, 0.0F, -2.0F, 2, 5, 2, 0.0F);
		...
		right_wing_0_1.addCuboid(0.0F, 0.0F, -13.0F, 0, 11, 18, 0.0F);
		...
		right_wing_1_1.addCuboid(-1.0F, 0.0F, -1.0F, 2, 4, 2, 0.0F);
		right_arm = new ModelRenderer(this, 40, 16);
		right_arm.setRotationPoint(-5.0F, 2.5F, 0.0F);
		right_arm.addCuboid(-2.0F, -2.0F, -2.0F, 3, 12, 4, 0.0F);
		...
		right_wing_0.addCuboid(0.0F, 0.0F, -13.0F, 0, 11, 18, 0.0F);
		...
		left_leg.addCuboid(-2.0F, 0.0F, -2.0F, 4, 12, 4, 0.0F);
		...
		body.addCuboid(-4.0F, 0.0F, -2.0F, 8, 12, 4, 0.0F);
		nose = new ModelRenderer(this, 0, 0);
		nose.setRotationPoint(0.0F, -3.7F, -4.0F);
		nose.addCuboid(-0.5F, -0.3F, 0.0F, 1, 2, 1, 0.0F);
		...
		right_leg.addCuboid(-2.0F, 0.0F, -2.0F, 4, 12, 4, 0.0F);
		...
		right_wing_2_1.addCuboid(-1.0F, 0.0F, 0.0F, 2, 7, 2, 0.0F);
	...
	@Override
	 public void render(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
		...
		head_2.render(matrixStack, iVertexBuilder, i, i1);
		head.render(matrixStack, iVertexBuilder, i, i1);
		RenderSystem.pushMatrix();
		RenderSystem.enableCull();
		RenderSystem.translatef(body.offsetX, body.offsetY, body.offsetZ);
		RenderSystem.translatef(body.rotationPointX * scale, body.rotationPointY * scale, body.rotationPointZ * scale);
