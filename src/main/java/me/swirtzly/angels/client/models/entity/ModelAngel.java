...
public class ModelAngel<T extends LivingEntity> extends EntityModel<T> {
	...
	public ModelAngel() {
		...
		LeftEyebrow.addCuboid(-2F, -1F, 0F, 2, 1, 1);
		...
		RightEyebrow.addCuboid(0F, -1F, 0F, 2, 1, 1);
		...
		Headband.addCuboid(-4.5F, 0F, -0.5F, 9, 1, 9);
		...
		ChinAngleLeft.addCuboid(-2F, -1F, 0F, 2, 1, 2);
		...
		ChinAngleRight.addCuboid(0F, -1F, 0F, 2, 1, 2);
		...
		CheekLeft.addCuboid(-4F, -1F, -4F, 3, 1, 1);
		...
		CheekRight.addCuboid(1F, -1F, -4F, 3, 1, 1);
		...
		HeadMain.addCuboid(-4F, -8F, -4F, 8, 7, 8);
		...
		HeadUnder.addCuboid(-4F, -1F, -3F, 8, 1, 7);
		...
		Hair2.addCuboid(-4F, 1F, 0F, 1, 1, 1);
		...
		Hair3.addCuboid(3F, 1F, 0F, 1, 1, 1);
		...
		Hair4.addCuboid(-1F, 0F, -4F, 1, 2, 1);
		...
		Hair5.addCuboid(-1F, 2F, -3F, 1, 2, 1);
		...
		Hair6.addCuboid(-1F, 4F, -2F, 1, 2, 1);
		...
		Hair7.addCuboid(-1F, 6F, -1F, 1, 1, 5);
		...
		Hair8.addCuboid(-4F, 6F, -1F, 8, 1, 1);
		...
		Hair9.addCuboid(0F, 6F, -1F, 1, 1, 5);
		...
		Hair10.addCuboid(0F, 4F, -2F, 1, 2, 1);
		...
		Hair11.addCuboid(0F, 2F, -3F, 1, 2, 1);
		...
		Hair12.addCuboid(0F, 0F, -4F, 1, 2, 1);
		...
		TorsoMain.addCuboid(-4F, 0F, -2F, 8, 23, 4);
		...
		Dress1.addCuboid(-4F, 0F, 0F, 8, 8, 1);
		...
		Dress2.addCuboid(-1F, 0F, -2F, 1, 8, 4);
		...
		Dress3.addCuboid(-4F, 0F, -1F, 8, 8, 1);
		...
		Dress4.addCuboid(0F, 0F, -2F, 1, 8, 4);
		...
		Dress5.addCuboid(-4F, 0F, 0F, 8, 12, 1);
		...
		Dress6.addCuboid(-1F, 0F, -2F, 1, 12, 4);
		...
		Dress7.addCuboid(-4F, 0F, -1F, 8, 12, 1);
		...
		Dress8.addCuboid(0F, 0F, -2F, 1, 12, 4);
		...
		Dress9.addCuboid(-4F, 0F, 0F, 8, 1, 3);
		...
		Dress10.addCuboid(-3F, 0F, -2F, 3, 1, 4);
		...
		Dress11.addCuboid(-4F, 0F, -3F, 8, 1, 3);
		...
		Dress12.addCuboid(0F, 0F, -2F, 3, 1, 4);
		...
		Dress13.addCuboid(-5F, 23F, -3F, 10, 1, 6);
		...
		RightArm1.addCuboid(-3F, -3F, 0F, 3, 3, 6);
		...
		RightArm2.addCuboid(-3F, -3F, -6F, 3, 3, 6);
		...
		LeftArm1.addCuboid(0F, -3F, 0F, 3, 3, 6);
		...
		LeftArm2.addCuboid(0F, -3F, -6F, 3, 3, 6);
		...
		LeftWing1.addCuboid(-3F, 0F, -1F, 3, 6, 1);
		...
		LeftWing2.addCuboid(0F, 0F, -1F, 3, 6, 1);
		...
		LeftWing3.addCuboid(3F, -2F, -1F, 1, 10, 1);
		...
		LeftWing4.addCuboid(4F, -3F, -1F, 1, 13, 1);
		...
		LeftWing5.addCuboid(5F, -4F, -1F, 1, 16, 1);
		...
		LeftWing6.addCuboid(6F, -4F, -1F, 1, 18, 1);
		...
		LeftWing7.addCuboid(7F, -3F, -1F, 1, 19, 1);
		...
		LeftWing8.addCuboid(8F, -2F, -1F, 1, 17, 1);
		...
		LeftWing9.addCuboid(9F, 0F, -1F, 1, 13, 1);
		...
		RightWing1.addCuboid(0F, 0F, -1F, 3, 6, 1);
		...
		RightWing2.addCuboid(-3F, 0F, -1F, 3, 6, 1);
		...
		RightWing3.addCuboid(-4F, -2F, -1F, 1, 10, 1);
		...
		RightWing4.addCuboid(-5F, -3F, -1F, 1, 13, 1);
		...
		RightWing5.addCuboid(-6F, -4F, -1F, 1, 16, 1);
		...
		RightWing6.addCuboid(-7F, -4F, -1F, 1, 18, 1);
		...
		RightWing7.addCuboid(-8F, -3F, -1F, 1, 19, 1);
		...
		RightWing8.addCuboid(-9F, -2F, -1F, 1, 17, 1);
		...
		RightWing9.addCuboid(-10F, 0F, -1F, 1, 13, 1);
		...
		AngryRightArm1.addCuboid(-3F, -3F, 0F, 3, 3, 6);
		...
		AngryRightArm2.addCuboid(-3F, -3F, -6F, 3, 3, 6);
		...
		AngryLeftArm1.addCuboid(0F, -3F, 0F, 3, 3, 6);
		...
		AngryLeftArm2.addCuboid(0F, -3F, -6F, 3, 3, 6);
	...
	@Override
	public void setAngles(T t, float v, float v1, float v2, float v3, float v4) {
	...
	public void render(MatrixStack matrixStack, IVertexBuilder iVertexBuilder, int i, int i1, float v, float v1, float v2, float v3) {
		...
		// Head
		RenderSystem.pushMatrix(); //PUSH 1


		RenderSystem.pushMatrix(); //PUSH 2
		if (!angel.getPose().equals(PoseManager.POSE_ANGRY.getRegistryName())) {
			RenderSystem.rotatef(20, 1, 0, 0);
		}
		LeftEyebrow.render(matrixStack, iVertexBuilder, i, i1);
		RightEyebrow.render(matrixStack, iVertexBuilder, i, i1);
		Headband.render(matrixStack, iVertexBuilder, i, i1);
		Nose.render(matrixStack, iVertexBuilder, i, i1);
		Chin.render(matrixStack, iVertexBuilder, i, i1);
		ChinAngleLeft.render(matrixStack, iVertexBuilder, i, i1);
		ChinAngleRight.render(matrixStack, iVertexBuilder, i, i1);
		CheekLeft.render(matrixStack, iVertexBuilder, i, i1);
		CheekRight.render(matrixStack, iVertexBuilder, i, i1);
		HeadMain.render(matrixStack, iVertexBuilder, i, i1);
		HeadUnder.render(matrixStack, iVertexBuilder, i, i1);
		Teeth.render(matrixStack, iVertexBuilder, i, i1);
		...
		Hair9.render(matrixStack, iVertexBuilder, i, i1);
		Hair10.render(matrixStack, iVertexBuilder, i, i1);
		Hair11.render(matrixStack, iVertexBuilder, i, i1);
		Hair12.render(matrixStack, iVertexBuilder, i, i1);
		RenderSystem.popMatrix(); //POP 1

		if (angel.getPose().equals(PoseManager.POSE_ANGRY.getRegistryName())) {
			AngryRightArm1.render(matrixStack, iVertexBuilder, i, i1);
			AngryRightArm2.render(matrixStack, iVertexBuilder, i, i1);
			AngryLeftArm1.render(matrixStack, iVertexBuilder, i, i1);
			AngryLeftArm2.render(matrixStack, iVertexBuilder, i, i1);
		} else {
		...
		LeftWing8.render(matrixStack, iVertexBuilder, i, i1);
		LeftWing9.render(matrixStack, iVertexBuilder, i, i1);
		...
		RightWing8.render(matrixStack, iVertexBuilder, i, i1);
		RightWing9.render(matrixStack, iVertexBuilder, i, i1);

		RenderSystem.popMatrix(); //POP 2
	}
}
