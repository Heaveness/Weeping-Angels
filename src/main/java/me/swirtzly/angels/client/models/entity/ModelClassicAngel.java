...
public class ModelClassicAngel <T extends LivingEntity> extends BipedModel<T>{
	...
	public ModelClassicAngel() {
		...
		leftfoot.addCuboid(-2F, 7F, -4F, 6, 5, 8);
		...
		rightfoot.addCuboid(-4F, 7F, -4F, 6, 5, 8);
		...
		leftwing1.addCuboid(-0.5F, -1F, 1.0F, 1, 5, 2);
		...
		leftwing2.addCuboid(-0.5F, -2F, 3F, 1, 11, 2);
		...
		leftwing3.addCuboid(-0.5F, -2F, 5F, 1, 18, 2);
		...
		leftwing4.addCuboid(-0.5F, 0.0F, 7F, 1, 14, 2);
		...
		rightwing1.addCuboid(-0.5F, -1F, 1.0F, 1, 5, 2);
		...
		rightwing2.addCuboid(-0.5F, -2F, 3F, 1, 11, 2);
		...
		rightwing3.addCuboid(-0.5F, -2F, 5F, 1, 18, 2);
		...
		rightwing4.addCuboid(-0.5F, 0.0F, 7F, 1, 14, 2);
		...
		body.addCuboid(-4F, 0.0F, -2F, 8, 12, 4);
		...
		rightarm.addCuboid(-3F, 0.0F, -2F, 4, 9, 4);
		...
		leftarm.addCuboid(-1F, 0.0F, -2F, 4, 9, 4);
		...
		rightleg.addCuboid(-2F, 0.0F, -2F, 4, 9, 4);
		...
		leftleg.addCuboid(-2F, 0.0F, -2F, 4, 9, 4);
